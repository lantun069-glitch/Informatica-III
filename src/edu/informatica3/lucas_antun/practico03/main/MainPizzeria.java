...
public class MainPizzeria {
    ...
    private void buscarPorEstado() {
        ...
        int opcion = leerOpcion();
        EstadoPedido estado = switch (opcion) {
            case 1 -> EstadoPedido.PENDIENTE;
            case 2 -> EstadoPedido.EN_PREPARACION;
            case 3 -> EstadoPedido.COMPLETADO;
            default -> null;
        };
        ...
        switch (opcion) {
            ...
            case 4:
                pizzeria.ordenarConComparador(
                    Comparadores.POR_ESTADO_Y_TIEMPO,
                    "estado y tiempo"
                );
                pizzeria.mostrarPedidos();
                break;
            case 5:
                pizzeria.ordenarConComparador(
                    Comparadores.POR_PRECIO_DESC_Y_TIEMPO,
