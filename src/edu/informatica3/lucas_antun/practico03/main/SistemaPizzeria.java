package edu.informatica3.lucas_antun.practico03.main;

import edu.informatica3.lucas_antun.practico03.algoritmos.*;
...
public class SistemaPizzeria {
     ...
     * @return true si se cambio correctamente, false si no se encontro
     */
    public boolean cambiarEstado(int id, EstadoPedido nuevoEstado) {
        Pedido pedido = buscarPorId(id);
        if (pedido != null) {
    ...
    public void mostrarEstadisticas() {
        ...
        long pendientes = contarPorEstado(EstadoPedido.PENDIENTE);
        long enPreparacion = contarPorEstado(EstadoPedido.EN_PREPARACION);
        long completados = contarPorEstado(EstadoPedido.COMPLETADO);
    ...
    public void cargarPedidosPrueba() {
        ...
        cambiarEstado(2, EstadoPedido.EN_PREPARACION);
        cambiarEstado(4, EstadoPedido.COMPLETADO);
        cambiarEstado(6, EstadoPedido.EN_PREPARACION);
        cambiarEstado(8, EstadoPedido.COMPLETADO);
